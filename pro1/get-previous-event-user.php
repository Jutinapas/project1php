<?php
    ...
    if($ses_sesid <> session_id() or $ses_userid =="" or $ses_userstatus != 'user'){
      ...
      $sql = "select * from userevent join event_detail ON userevent.user_id = $ses_userid WHERE userevent.event_id = event_detail.event_id ORDER BY event_detail.event_date DESC, event_detail.event_start DESC";
                ...
                <div class='card'>
                  <div class='card-body' style='padding-bottom: 10px;'>
                    <a href='../event/showEvent.html?event=" . $data['event_id'] . "'>
                      <div class='row'>
                        <div class='col-xs-10'>
                          <img src='$data[event_poster]' alt='Event image'>
                        </div>
                        <div class='col-sm-8'>
